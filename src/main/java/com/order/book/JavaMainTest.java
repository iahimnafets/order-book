...
public class JavaMainTest {
    ...
    public static void main(String[] args) {
        ...
        orderBook.addOrder(new Order(8, 101.1, 'B', 7));
        ...
        orderBook.addOrder(new Order(6, 93.0, 'O', 4));
        orderBook.addOrder(new Order(7, 93.0, 'O', 3));
        ...
        System.out.println("=> Best offer price: " + orderBook.getPrice('O', 1));
